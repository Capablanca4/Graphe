...
void cfs_apsVersAdj(int *fs,int *aps,int **&A){ /// Fonction à tester absolument !!!
...
void fs_apsVersfpp_app(int *fs,int *aps,int *&fp,int *&app){ /// Fonction étrange et à tester
